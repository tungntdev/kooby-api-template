create or replace table patient_request
(
...
create or replace table approvals
(
    id                 int auto_increment primary key,
...
create or replace table delivery_fee
(
    id          int auto_increment primary key,
    id_district int               null,
    fee         int               null,
...
create or replace table state_history
(
    id                 int auto_increment primary key,
    id_patient_request int      null,
    state              tinyint  null,
...
create or replace table village
(
    id          int auto_increment primary key,
    id_district int               null,
    name        varchar(255)      null,
